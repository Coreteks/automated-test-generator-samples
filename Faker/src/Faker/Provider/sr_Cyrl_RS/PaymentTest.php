...
namespace tests\Faker\Provider\sr_Cyrl_RS;

use Faker\Provider\sr_Cyrl_RS\Payment;
use Mockery as m;

class PaymentTest extends \PHPUnit_Framework_TestCase
{
/**
* @var \Faker\Provider\sr_Cyrl_RS\Payment
*/
protected $payment;
...
public function setUp()
{
    ...
    $this->payment = new \Faker\Provider\sr_Cyrl_RS\Payment();
}
